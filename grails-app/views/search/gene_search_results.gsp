...
<html>
		...
		var oTable = $('#table_data').dataTable( {
			...
			"aoColumns": [
				...
				"fnRender": function ( oObj, sVal ){
					return "<a href=\"m_info?Gid=${metaData.id}&GFFid=${params.GFFid}&mid="+oObj.aData["mrna_id"]+"\">"+sVal+"</a>";				}},
				{ "mDataProp": "anno_db" },
				{ "mDataProp": "anno_id",
				"fnRender": function ( oObj, sVal ){
					AnnoData = ${jsonAnno};
  ...
  <g:link action="">Search</g:link> > <g:link action="species">Species</g:link> > <g:link action="species_v" params="${[Gid:metaData.meta.id]}"><i> ${metaData.meta.genus} ${metaData.meta.species}</i></g:link> > <g:link action="species_search" params="${[Gid:params.Gid,GFFid:params.GFFid]}">${metaData.gversion}</g:link> > Search results
