		...
		var oTable = $('#table_data').dataTable( {
			...
			"aoColumns": [
				...
				"fnRender": function ( oObj, sVal ){
					return "<a href=\"m_info?Gid=${metaData.genome.id}&GFFid=${params.GFFid}&mid="+oObj.aData["mrna_id"]+"\">"+sVal+"</a>";				}},
				{ "mDataProp": "anno_db" },
				{ "mDataProp": "anno_id",
				"fnRender": function ( oObj, sVal ){
					AnnoData = ${jsonAnno};
