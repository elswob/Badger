...
<html>
 ...
 <h1>Genome:</h1>
 <table>
 <tr><td><b>Span (bp)</b></td><td><b>Scaffolds</b></td><td><b>N50</b></td><td><b>Smallest (bp)</b></td><td><b>Largest (bp)</b></td><td><b>GC (%)</b></td><td><b>Non ATGC (bp)</b></td></tr>
 ...
 <h1>Genes:</h1>
 <table>
 <tr><td><b>Number</b></td><td><b>Mean length (bp)</b></td><td><b>Smallest (bp)</b></td><td><b>Largest (bp)</b></td><td><b>GC (%)</b></td><td><b>Non ATGC (bp)</b></td></tr>
 <tr><td>${printf("%,d\n",GDB.GeneInfo.count())}</td><td>${printf("%,d\n",gene_stats.mean)}</td><td>${printf("%,d\n",gene_stats.min)}</td><td>${printf("%,d\n",gene_stats.max)}</td><td>${printf("%.4g",gene_stats.gc)}</td><td>${printf("%,d\n",gene_stats.nonATGC)}</td></tr>
 </table>
