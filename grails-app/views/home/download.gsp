  ...
  <div class="bread"><g:link action="">Home</g:link> > Download</div>
    ...
    <sec:ifNotLoggedIn>
    	<g:each var="res" in="${files}">
    		...
    		<% if (sp == ""){ 
    			println "<tr><td colspan=2><h1>${res.genus} ${res.species}</h1></td></tr><tr><td width=120><a href = \"/search/species_v?Sid=${res.sid}\"><img src=\"${resource(dir: 'images', file: res.image_file)}\" width=\"120\" style=\"float:left;\"/></a></td><td><table>"
