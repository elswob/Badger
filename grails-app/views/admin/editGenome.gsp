 ...
 <script>
  function demoData(sp){
  	if (sp == "badger"){
		...
		$("#genome_url").val("ftp://link_to_genome_data"); $("#genes_url").val("ftp://link_to_gene_data"); $("#mrna_trans_url").val("ftp://link_to_transcript_data"); $("#mrna_pep_url").val("ftp://link_to_peptide_data"); 
	}
	if (sp == "badger2"){
		...
		$("#genes_url").val("ftp://link_to_gene_data"); $("#mrna_trans_url").val("ftp://link_to_transcript_data"); $("#mrna_pep_url").val("ftp://link_to_peptide_data"); 
	}
  }
  </script>
...
<g:if test="${genome.files.size()<1}">
	...
	<div class="inline">
		...
		<table width=100%>
			<tr>
				<td width="25%"><b>Genome (FASTA file)</b><font color="red">*</font><br>
				...
				<td width="25%"><b>Description</b><br>
					<g:textField name="genome_d" style="width:100%; height: 18px; border: 3px solid #cccccc; padding: 2px;"/>
				</td>
				<td width="20%"><b>Data URL</b><br>
					<g:textField name="genome_url" style="width:100%; height: 18px; border: 3px solid #cccccc; padding: 2px;"/>
				</td>
			...
			<tr>
				...
				<td width="20%"><b>Data URL</b><br>
					<g:textField name="genes_url" style="width:100%; height: 18px; border: 3px solid #cccccc; padding: 2px;"/>
				</td>
			...
			<tr>
				<td width="20%"><b>mRNA transcripts (FASTA file)</b><br>
				...
				<td width="25%"><b>Data URL</b><br>
					<g:textField name="mrna_trans_url" style="width:100%; height: 18px; border: 3px solid #cccccc; padding: 2px;"/>
				</td>
				<td width="5%"><br>n/a</td>
			...
			<tr>
				...
				<td width="20%"><b>Data URL</b><br>
					<g:textField name="mrna_pep_url" style="width:100%; height: 18px; border: 3px solid #cccccc; padding: 2px;"/>
				</td>
				<td width="5%"><br>n/a</td>
	...
	<g:form action="addedFiles" name="extraGff">
		...
		<table width=100%>	
			<tr>
				...
				<td width="5%"><b>Version</b><br>
					<g:textField name="genes_v" style="width:100%; height: 18px; border: 3px solid #cccccc; padding: 2px;"/>
				</td>
				<td width="35%"><b>Description</b><br>
					<g:textField name="genes_d" style="width:100%; height: 18px; border: 3px solid #cccccc; padding: 2px;"/>
				</td>
				<td width="20%"><b>Data URL</b><br>
					<g:textField name="genes_url" style="width:100%; height: 18px; border: 3px solid #cccccc; padding: 2px;"/>
